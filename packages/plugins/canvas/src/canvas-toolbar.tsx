 ...
 * this surface contributes no literal naming any tool, including its own two. `select` and
 ...
 * no reload (R3).
 *
 * The only judgement left here is ORDER, which is this surface's to make: the canvas's own
