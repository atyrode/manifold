...
- Inspect only your authorized run chain through core.access.inspectAgentRun. The projection contains retained mechanical facts, not the workspace-wide journal; missing origins and unsettled traces are not evidence of success or cleanup.
